...
function SupportSection() {
  ...
  <div className="row">
    <div className="col left">
      <div className="card">
      <img src="https://raw.githubusercontent.com/surendran12/uzopay/main/src/assets/Video.png" alt="AI Robot" />
    ...
    <p> <img src="https://raw.githubusercontent.com/surendran12/uzopay/main/src/assets/Video1.png" alt="AI Robot" /></p>
  ...
  <div className="row">
    ...
    Simple API integration with your existing systems and platforms.
        ...
        <button>Learn more →</button>
    <p> <img src="https://raw.githubusercontent.com/surendran12/uzopay/main/src/assets/Video3.png" alt="" /></p>
     <br/>
      </div>
    </div>
    ...
    <div className="col left">
      ...
      Flexible Solutions
        ...
        <h3></h3>
        <img src="https://raw.githubusercontent.com/surendran12/uzopay/main/src/assets/Video4.png" alt="AI Robot" />
